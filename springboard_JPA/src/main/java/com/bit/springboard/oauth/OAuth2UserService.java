...
public class OAuth2UserService extends DefaultOAuth2UserService {
    ...
    // -> 토큰 발행 및 수정 -> 토큰을 통해 사용자 정보 취득 -> loadUser 메소드를 자동호출
    //loadUser 메솓만 구현하면 된다. loadUser에서 처리할 내용은 취득한 사용자 정보 커스터마이징
    @Override
    public OAuth2User loadUser(OAuth2UserRequest userRequest){
        ...
        //소셜 로그인은 비밀번호가 필요하지 않기 때문에 nickname 값을 암호화해서 넣는다.
